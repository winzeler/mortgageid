...
export default {
  ...
  props: {
    ...
    /**
     * @type {String} The date the team signed up.
     */
    joined: {
      type: String,
      required: true,
    ...
    /**
     * @type {String} The product/price plan the team is on.
     */
    plan: {
      type: String,
      default: undefined,
    ...
    /**
     * @type {String} The MRR this team contributes.
     */
    mrr: {
      type: String,
      default: undefined,
  ...
  computed: {
    /**
     * The active team's gravatar URL.
     *
     * @return {String}
     */
    gravatarUrl() {
      return `https://www.gravatar.com/avatar/${md5(this.name.trim().toLowerCase())}?d=robohash`;
    },
